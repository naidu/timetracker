...
if ($jwt) {
  try {
    ...
    if ($isLoggedIn) {
      $project_list = ttTimeSweHelper::getprojects();
      foreach($project_list as &$value){
            $value[project]= ttTimeSweHelper::getprojectsname($value[project_id]);
      }
      $projects_with_null_clients = ttTimeSweHelper::getnullClientProjects();
